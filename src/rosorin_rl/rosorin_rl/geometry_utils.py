...
# ---------------------------------------------------------------------------
# 차폐물(occluder) — 작물 줄 4개의 2D AABB (xmin, ymin, xmax, ymax) [m, 월드좌표]
#
# 출처: greenhouse_sim/scripts/gen_greenhouse_world.py 레이아웃
#   NUM_ROWS=4, row_pitch=AISLE_WIDTH(0.8)+FOLIAGE_D_Y(0.2)=1.0,
#   원점 평행이동(통로 입구=원점) 후 줄 중심 y = −1.5 / −0.5 / +0.5 / +1.5, 잎 깊이 ±0.1
#   x 범위: 식물 중심 0.84..6.34 ± 잎 가로 반폭 0.24 → 0.60..6.58
# 잎 높이 1.4m > 마커 높이 0.20m 이므로 수평(2D) 교차 검사만으로 충분하다.
#
...
OCCLUDERS = [
    (0.60, -1.6, 6.58, -1.4),   # 줄0 (y=-1.5)
    (0.60, -0.6, 6.58, -0.4),   # 줄1 (y=-0.5) — 중앙 통로의 남쪽 잎벽
    (0.60,  0.4, 6.58,  0.6),   # 줄2 (y=+0.5) — 중앙 통로의 북쪽 잎벽
    (0.60,  1.4, 6.58,  1.6),   # 줄3 (y=+1.5) — 신규
]
